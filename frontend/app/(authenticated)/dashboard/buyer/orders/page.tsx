...
export default function BuyerOrdersPage() {
  ...
  const SYNTHETIC_ORDERS = [
    {
      id: 'ord-b1c2', status: 'in_transit', created_at: new Date().toISOString(), total_amount: 14000, delivery_address: 'Main Store, Pune', delivery_date: '2026-09-05',
      items: [{ id: '1', quantity_kg: 500, price_per_kg: 28, status: 'accepted' }]
    },
    {
      id: 'ord-d3e4', status: 'delivered', created_at: new Date().toISOString(), total_amount: 4200, delivery_address: 'Warehouse A, Mumbai', delivery_date: '2026-09-01',
      items: [{ id: '2', quantity_kg: 200, price_per_kg: 21, status: 'fulfilled' }]
    }
  ];
